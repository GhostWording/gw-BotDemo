...
import com.ghostwording.chatbot.databinding.ActivityTranslationBinding;
import com.ghostwording.chatbot.dialog.ShareDialog;
import com.ghostwording.chatbot.io.QuotesLoader;
import com.ghostwording.chatbot.model.listeners.OnPageSelectedListener;
...
public class TranslationActivity extends BaseActivity {
    ...
    private void initControls() {
        ...
        binding.btnSend.setOnClickListener(v -> {
            try {
                ShareDialog.show(TranslationActivity.this, imageUrl, adapter.getQuote(binding.vpItems.getCurrentItem()), isBubble);
            } catch (Exception ex) {
                Logger.e(ex.toString());
            }
        });
