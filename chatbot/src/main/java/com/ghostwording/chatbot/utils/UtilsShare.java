...
public class UtilsShare {
    ...
    public static void shareViaIntent(final Activity activity, String selectedImageUri, final Quote quote, final boolean isConcatenateImageWithText, boolean isBubble) {
        ...
        AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_VIA_INTENT, quote, selectedImageUri, additionalParameter);
    ...
    public static void shareByEmail(final Activity activity, String selectedImageUri, @Nullable final Quote selectedQuote) {
        AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_EMAIL, selectedQuote, selectedImageUri, null);
    ...
    public static void shareBySMS(Activity activity, String imageUri, Quote quote) {
        ...
        AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_SMS, quote, imageUri, null);
