...
public class AnalyticsHelper {
    ...
    public static void sendShareEvent(String event, Quote quote, String imageUri, String additionalParameter) {
        if (quote != null) {
        ...
        if (imageUri != null) {
            ...
            AnalyticsHelper.sendShareImageEvent(event, imageName, additionalParameter);
            if (quote != null) {
    ...
    public static void sendShareImageEvent(String event, String selectedImageUri, String additionalParameter) {
        if (additionalParameter == null) {
            AnalyticsHelper.sendEvent(AnalyticsHelper.Categories.IMAGE, event, selectedImageUri);
        } else {
            AnalyticsHelper.sendEvent(AnalyticsHelper.Categories.IMAGE, event, selectedImageUri, additionalParameter);
        }
    }
