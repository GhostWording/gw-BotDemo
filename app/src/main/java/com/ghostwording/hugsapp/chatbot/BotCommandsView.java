...
import com.ghostwording.hugsapp.model.intentions.IntentionSelectedListener;
...
public class BotCommandsView {
    ...
    public BotCommandsView(final Activity activity, final FrameLayout container, ChatAdapter chatAdapter) {
    ...
    public void showIntentionsCommandForRecipient(Recipient recipient, final IntentionSelectedListener intentionSelectedListener) {
        ...
        for (Intention item : AppConfiguration.getIntentions()) {
            ...
            if (recipient.getRelationTypeTag() == null || item.getRelationTypesString().contains(recipient.getRelationTypeTag())) {
                intentions.add(item);
            }
        }
        ...
        for (
                final Intention intention : intentions)
    ...
    public void setCommandsOnBoarding(final BotSequence sequence, final SequenceHandler.CommandListener commandListener) {
        clearCommand();
