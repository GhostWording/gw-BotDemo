...
import com.ghostwording.hugsapp.textimagepreviews.TranslationActivity;
...
public class Utils {
    ...
    public static String getLocalizedLabel(BotSequence.Label label) {
        ...
        int selectedLanguage = LocaleManager.getSelectedLanguage(BotDemoApplication.instance());
    ...
    public static void shareSticker(AppCompatActivity activity, String imageUrl, String imageName, Quote quote) {
        if (quote != null) {
            ...
            if (imageName != null) {
                ShareDialog.show(activity, imageUrl, imageName, quote, false);
            } else {
