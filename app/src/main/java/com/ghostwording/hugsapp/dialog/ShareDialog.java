...
public class ShareDialog extends BaseDialog {
    ...
    public static void show(FragmentActivity activity, String selectedImageUri, Quote selectedQuote, boolean isBubble) {
        show(activity, selectedImageUri, Utils.getFilenameFromUri(selectedImageUri), selectedQuote, isBubble);
    }

    public static void show(FragmentActivity activity, String selectedImageUri, String imageName, Quote selectedQuote, boolean isBubble) {
        ...
        try {
            ...
            sendDialog.imageName = imageName;
    ...
    public class SendItemsView {
        ...
        private void onShareAction(String action) {
            ...
            if (action.equals(getString(R.string.share_dialog_messenger))) {
                AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_MESSENGER, selectedQuote, selectedImageUri, PictureSource.SERVER, AnalyticsHelper.Parameters.TEXT_PLUS_IMAGE);
            ...
            if (action.equals(getString(R.string.share_dialog_facebook))) {
                AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_FACEBOOK_WALL, selectedQuote, selectedImageUri, PictureSource.SERVER, AnalyticsHelper.Parameters.TEXT_PLUS_IMAGE);
            ...
            if (action.equals(getString(R.string.share_dialog_as_postcard))) {
                UtilsShare.shareViaIntent(getActivity(), selectedImageUri, selectedQuote, true, PictureSource.SERVER, isBubble);
            }
            if (action.equals(getString(R.string.share_dialog_separate))) {
                UtilsShare.shareViaIntent(getActivity(), selectedImageUri, selectedQuote, false, PictureSource.SERVER, isBubble);
            }
            if (action.equals(getString(R.string.share_dialog_whatsapp))) {
                AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_WHATS_APP, selectedQuote, selectedImageUri, PictureSource.SERVER, AnalyticsHelper.Parameters.TEXT_PLUS_IMAGE);
            ...
            if (action.equals(getString(R.string.share_dialog_viber))) {
                AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_VIBER, selectedQuote, selectedImageUri, PictureSource.SERVER, null);
                UtilsShare.shareByPackageName(getActivity(), Utils.VIBER_PACKAGE, selectedImageUri, selectedQuote, true, isBubble);
            }
            if (action.equals(getString(R.string.share_dialog_snapchat))) {
                AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_SNAPCHAT, selectedQuote, selectedImageUri, PictureSource.SERVER, null);
            ...
            if (action.equals(getString(R.string.share_dialog_instagram))) {
                AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_INSTAGRAMM, selectedQuote, selectedImageUri, PictureSource.SERVER, null);
            ...
            if (action.equals(getString(R.string.share_dialog_twitter))) {
                AnalyticsHelper.sendShareEvent(AnalyticsHelper.Events.SHARE_TWITTER, selectedQuote, selectedImageUri, PictureSource.SERVER, null);
